...
Функция ЗагрузкаИзКонфигуратораТЕСТ()
	...
	ФайлЖурнала.ОткрытьФайл("LoadRepoVir.log");
	...
	ПутьБазы = """DC2ERPAPP03:3541/Test_Integration""";
	СтрокаСоединения = "/S"+ПутьБазы;
	Пользователь ="ВиричПавел";
	Пароль = "125689";
	
	СтрокаСоединенияХран = "tcp://dc2erprep01.aobi.local/rep_erp_dev_01";
	ПользовательХран ="Test_Integration";
	ПарольХран = 123;
