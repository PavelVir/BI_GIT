...
Структура сценария: Я связываю несколько работ с типом связи по таблице с запаздываением 1 
...
И я проверяю корректность данных
    ...
    |$КлючСтроки2$|
    И поле таблицы "ВзаимосвязиРаботПоследователи" "ВзаимосвязиРаботПоследователиКлючСтрокиА" равно переменной <ПроверяемыйКлюч1>
    И в таблице "ВзаимосвязиРаботПоследователи" поле "Тип связи" имеет значение <ТекущийТип>

    И в таблице "ВзаимосвязиРаботПоследователи" я перехожу к строке:
    |'Ключ строки последующей работы'|
    |$КлючСтроки3$|
    И поле таблицы "ВзаимосвязиРаботПоследователи" "ВзаимосвязиРаботПоследователиКлючСтрокиА" равно переменной <ПроверяемыйКлюч2>
    И в таблице "ВзаимосвязиРаботПоследователи" поле "Тип связи" имеет значение <ТекущийТип>

    И в таблице "ВзаимосвязиРаботПоследователи" я перехожу к строке:
    |'Ключ строки последующей работы'|
    |$КлючСтроки4$|
    И поле таблицы "ВзаимосвязиРаботПоследователи" "ВзаимосвязиРаботПоследователиКлючСтрокиА" равно переменной <ПроверяемыйКлюч3>
    И в таблице "ВзаимосвязиРаботПоследователи" поле "Тип связи" имеет значение <ТекущийТип>

    И в таблице "ВзаимосвязиРаботПоследователи" я перехожу к строке:
    |'Ключ строки последующей работы'|
    |$КлючСтроки5$|
    И поле таблицы "ВзаимосвязиРаботПоследователи" "ВзаимосвязиРаботПоследователиКлючСтрокиА" равно переменной <ПроверяемыйКлюч4>
    И в таблице "ВзаимосвязиРаботПоследователи" поле "Тип связи" имеет значение <ТекущийТип>
...
Примеры:
|ТекущийТип|ПроверяемыйКлюч1|ПроверяемыйКлюч2|ПроверяемыйКлюч3|ПроверяемыйКлюч4|
|"Окончание-начало (ОН)"|"КлючСтроки1"|"КлючСтроки2"|"КлючСтроки3"|"КлючСтроки4"|
|"Окончание-окончание (ОО)"|"КлючСтроки1"|"КлючСтроки1"|"КлючСтроки1"|"КлючСтроки1"|
|"Начало-начало (НН)"|"КлючСтроки1"|"КлючСтроки1"|"КлючСтроки1"|"КлючСтроки1"|
|"Начало-окончание (НО)"|"КлючСтроки1"|"КлючСтроки2"|"КлючСтроки3"|"КлючСтроки4"|
