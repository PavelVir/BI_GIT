...
Сценарий: Я Проверяю работу обработки загрузки формата2018_Коэф
	...
	И в таблице "РаботыДЗ" поле "НР 2 уровня" имеет значение "101 500,66"
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "49 723,26"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "671 263,34"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-671 263,34"
