...
И для каждого файла "ИмяФайла" из каталога 'E:/DOCUMENTS/Mega/ПРОЕКТЫ/BI_GIT/features/_Комплексный тест загрузки проекта 27 улицы/kenml'	 
	И я вывожу значение переменной "ИмяФайла"		
	И я буду выбирать внешний файл '"E:/DOCUMENTS/Mega/ПРОЕКТЫ/BI_GIT/features/_Комплексный тест загрузки проекта 27 улицы/kenml/"+$ИмяФайла$' 
