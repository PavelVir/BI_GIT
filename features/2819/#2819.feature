...
Допустим я заполняю первоначальные настройки
	...
	И из выпадающего списка "Определитель" я выбираю по строке  "Буровзрывные работы"	
	И из выпадающего списка "Родительская группа сборников" я выбираю по строке  "Группа 4"		
	И из выпадающего списка "Сметно-нормативная база" я выбираю по строке 'Казахстан. BI-Group'
	И я выбираю значение реквизита "Район (зона) строительства" из формы списка
	Тогда открылось окно 'Территориальные районы строительства'
...
Тогда создается элемент справочника "ВИДЫ АНАЛОГИЧНЫХ РАБОТ"
	...
	Тогда открылось окно 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров (Виды аналогичных работ (шаблон наименований))'
	...
	Тогда таблица "Список" стала равной:
		| 'Вид сравнения' | 'Номер свойства шаблона' | 'Ограничение по значениям свойств' | 'Наименование свойства' | 'Шаблон'                                                                                                                   | 'Номер свойства ограничения' | 'Значение свойства' | 'Ограничения по свойству' |
		| 'Не равно'      | 'свойство2'              | 'Легкий'                           | 'Мощность'              | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'от 103 до 219 кВт' | 'Вид бульдозера'          |
		| 'Не равно'      | 'свойство2'              | 'Легкий'                           | 'Мощность'              | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'от 220 до 405 кВт' | 'Вид бульдозера'          |
		| 'Равно'         | 'свойство2'              | 'Легкий'                           | 'Мощность'              | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'от 37 до 96 кВт'   | 'Вид бульдозера'          |
		| 'Не равно'      | 'свойство3'              | 'Легкий'                           | 'Вид грунта'            | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'Скальные грунты'   | 'Вид бульдозера'          |
		| 'Равно'         | 'свойство4'              | 'Легкий'                           | 'Дальность'             | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'до 500'            | 'Вид бульдозера'          |
		| 'Не равно'      | 'свойство4'              | 'Легкий'                           | 'Дальность'             | 'Планировка площадей [свойство1] бульдозерами мощностью [свойство2] грунта вида [свойство3] дальностью [свойство4] метров' | 'свойство1'                  | 'свыше 500'         | 'Вид бульдозера'          |
	И В текущем окне я нажимаю кнопку командного интерфейса 'Свойства значений норм (привязка свойств к шаблону)'
	И пауза 1	
...
И в закладке "Свойства значений" заполняются по сохраненным данным все настройки 
	...
	Тогда таблица "ОграниченияСвойств" стала равной:
		| 'Значение свойства ограничения' | 'Номер свойства' | 'Свойство (новый справочник)' | 'Номер свойства ограничения' | 'Вид сравнения' | 'Свойство ограничения' | 'Значение свойства' |
		| 'Легкий'                        | 'свойство2'      | 'Мощность'                    | 'свойство1'                  | 'Не равно'      | 'Вид бульдозера'       | 'от 220 до 405 кВт' |
		| 'Легкий'                        | 'свойство2'      | 'Мощность'                    | 'свойство1'                  | 'Не равно'      | 'Вид бульдозера'       | 'от 103 до 219 кВт' |
		| 'Легкий'                        | 'свойство2'      | 'Мощность'                    | 'свойство1'                  | 'Равно'         | 'Вид бульдозера'       | 'от 37 до 96 кВт'   |
		| 'Легкий'                        | 'свойство3'      | 'Вид грунта'                  | 'свойство1'                  | 'Не равно'      | 'Вид бульдозера'       | 'Скальные грунты'   |
		| 'Легкий'                        | 'свойство4'      | 'Дальность'                   | 'свойство1'                  | 'Не равно'      | 'Вид бульдозера'       | 'свыше 500'         |
		| 'Легкий'                        | 'свойство4'      | 'Дальность'                   | 'свойство1'                  | 'Равно'         | 'Вид бульдозера'       | 'до 500'            |
...
Проверяем формирование состава работ
	...
	Тогда открылось окно 'B i свойства значений норм'
	И в таблице "Список" я перехожу к строке:
	| 'Наименование'   |
	| 'Вид бульдозера' |
	И в таблице "Список" я выбираю текущую строку
	...
	И в таблице "КомпоновщикНастройкиОтбор" в поле 'Значение' я ввожу текст 'Легкий'
	И в таблице "КомпоновщикНастройкиОтбор" я завершаю редактирование строки
	...
	Если открылось окно 'В указанных видах работ уже заполнен состав работ, хотите перезаполнить новым составом?'
...
Проверяем формирование  материального состава работ
	...
	Заполняю ресурс щебень
		...
		Если открылось окно 'В указанных видах работ уже заполнен состав звена. Очистить значения по трудовым и машинным ресурсам?'
			И я нажимаю на кнопку 'Да'
	...
	Проверяю что он есть в работе	
		...
		| 'Ед изм' | 'Текущая зарплата машинистов' | 'Наименование' | 'Код'    | 'Норма расхода' | 'Ресурс' | 'Тип ресурса' | 
