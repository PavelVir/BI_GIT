...
Сценарий: 2. Создание УГПР (Бюджет проекта переменных затрат)
...
Сценарий: 4. УПДП (Условия по договору с подрядчиком)
    Допустим Я открываю основную форму списка документа "ИНАГРО_УсловияПоДоговоруСПодрядчиком"
    ...
    И из выпадающего списка с именем "СтавкаНДС" я выбираю точное значение '12%'
