...
Я проверяю результат деления в УГПР
    ...
    | 'Итоги по работам'                                                     | ''        | ''        | '20'               | ''                | ''                       | '7 437,78'                | '7 437,78'            | '7 500,00'            | ''    | '62,22' |
    | 'Земляные работы'                                                      | '0'       | ''        | '20'               | ''                | ''                       | '7 437,78'                | '7 437,78'            | '7 500,00'            | ''    | '62,22' |
    ...
    | 'Водоотлив из котлованов'                                              | '3'       | 'м3'      | '2'                | '442,00'          | 'Е1-173-2'               | '884,00'                  | '884,00'              | '891,39'              | ''    | '7,39'  |
