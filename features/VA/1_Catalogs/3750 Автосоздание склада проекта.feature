...
Сценарий: Я создаю новый проект с текущей датой как название и проверяю что создался склад
	...
	И Я запоминаю значение выражения 'Строка(ТекущаяДата())' в переменную 'ДатаДляОтчета'
	И Я запоминаю значение выражения '"Склад проекта " + ТекущаяДата()' в переменную "СкладПроекта"
