...
#report.story=Проверка загрузки формата 5.5.2.1
...
Сценарий: Я Проверяю работу обработки загрузки формата5521
	...
	И я буду выбирать внешний файл "$КаталогПроекта$\ERP_ПроверкаЗагрузкиКенмл\Формат5521.kenml"
	...
	И в таблице "РаботыДЗ" поле "Стоимость прямых затрат" имеет значение "3 168 474,04"
	...
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "327 275,65"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "4 418 252,69"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-4 418 252,69"
