...
#report.story=Проверка загрузки формата 5.5.5

Функционал: Проверка загрузки формата 555 позиции без ресурсов
...
Сценарий: Я Проверяю работу обработки загрузки Формата555_Безресурсов
	...
	И я буду выбирать внешний файл "$КаталогПроекта$\ERP_ПроверкаЗагрузкиКенмл\Формат555_Безресурсов.kenml"
	...
	И в таблице "РаботыДЗ" поле с именем "РаботыДЗВидРаботы" имеет значение "Ограждения"
	И в таблице "РаботыДЗ" поле "Код WBS" имеет значение "2-7"
	И в таблице "РаботыДЗ" поле "Стоимость прямых затрат" имеет значение "40 436 803,87"
	И в таблице "РаботыДЗ" поле "НР 1 уровня" имеет значение "1 336 258,00"
	И в таблице "РаботыДЗ" поле "НР 2 уровня" имеет значение "1 300 236,00"
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "3 445 863,80"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "46 519 161,67"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-46 519 161,67"
