...
Сценарий: Я Проверяю работу обработки загрузки формата2018_ с ошибкой расчета ставки СП
	...
	И я буду выбирать внешний файл "$КаталогПроекта$\ERP_ПроверкаЗагрузкиКенмл\Формат2018_1_НеверныйРасчетСтавкиСП.kenml"
	...
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "481 293,87"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "6 497 467,21"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-6 497 467,21"
