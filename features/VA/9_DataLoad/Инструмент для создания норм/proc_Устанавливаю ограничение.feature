...
И в таблице "ОграниченияСвойств" я выбираю текущую строку
...
И в таблице "ОграниченияСвойств" я выбираю текущую строку
#И я нажимаю кнопку выбора у поля "Значение свойства ограничения"
#И в таблице "ОграниченияСвойств" из выпадающего списка "Значение свойства ограничения" я выбираю по строке "Парам4"
И в таблице "ОграниченияСвойств" из выпадающего списка с именем "ОграниченияСвойствЗначениеСвойстваОграничения_Представление" я выбираю точное значение"Парам4"
И в таблице "ОграниченияСвойств" я завершаю редактирование строки