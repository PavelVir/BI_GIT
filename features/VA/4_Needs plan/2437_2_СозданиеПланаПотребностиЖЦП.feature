...
Сценарий: Я создаю план потребности в материалах на ЖЦП
	...
	Тогда таблица "РесурсыМатериалыДЗ" стала равной:
		...
		| ''               | 'Конструктив 1'      | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | 'Работа на год'      | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | ''                   | 'Бензин А-92'  | 'Январь'   | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Январь'   | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Февраль'  | '28,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '28,000000'         |
		| ''               | ''                   | 'Болт'         | 'Февраль'  | '56,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '56,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Март'     | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Март'     | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Апрель'   | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Апрель'   | '60,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '60,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Май'      | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Май'      | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Июнь'     | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Июнь'     | '60,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '60,000000'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Июль'     | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Июль'     | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		...
		| ''               | ''                   | 'Бензин А-92'  | 'Декабрь'  | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Декабрь'  | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		| ''               | 'Работа на месяц'    | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | ''                   | 'Бензин А-92'  | 'Август'   | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Август'   | '62,000000'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '62,000000'         |
		...
		| ''               | 'Работа на два года' | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | ''                   | 'Бензин А-92'  | 'Январь'   | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Январь'   | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Февраль'  | '28,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '28,000000'         |
		| ''               | ''                   | 'Болт'         | 'Февраль'  | '308,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '308,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Март'     | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Март'     | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Апрель'   | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Апрель'   | '330,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '330,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Май'      | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Май'      | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Июнь'     | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Июнь'     | '330,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '330,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Июль'     | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Июль'     | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Август'   | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Август'   | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Сентябрь' | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Сентябрь' | '330,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '330,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Октябрь'  | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Октябрь'  | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Ноябрь'   | '30,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,000000'         |
		| ''               | ''                   | 'Болт'         | 'Ноябрь'   | '330,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '330,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Декабрь'  | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Декабрь'  | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Январь'   | '31,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '31,000000'         |
		| ''               | ''                   | 'Болт'         | 'Январь'   | '341,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '341,000000'        |
		| ''               | ''                   | 'Бензин А-92'  | 'Февраль'  | '28,000000'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '28,000000'         |
		| ''               | ''                   | 'Болт'         | 'Февраль'  | '308,000000' | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '308,000000'        |
