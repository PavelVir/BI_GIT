...
#report.story=Проверка загрузки формата 5.5.3.1

Функционал: Проверка загрузки формата 5.5.3.1
...
Сценарий: Я Проверяю работу обработки загрузки формата5531
	...
	И я буду выбирать внешний файл "$КаталогПроекта$\ERP_ПроверкаЗагрузкиКенмл\Формат5531.kenml"
	...
	И в таблице "РаботыДЗ" поле с именем "РаботыДЗВидРаботы" имеет значение "Строительство дороги"
	И в таблице "РаботыДЗ" поле "Код WBS" имеет значение "2-4"
	И в таблице "РаботыДЗ" поле "Стоимость прямых затрат" имеет значение "2 228 640,00"
	И в таблице "РаботыДЗ" поле "НР 1 уровня" имеет значение "53 630,00"
	И в таблице "РаботыДЗ" поле "НР 2 уровня" имеет значение "82 162,00"
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "189 155,00"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "2 553 587,00"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-2 553 587,00"
