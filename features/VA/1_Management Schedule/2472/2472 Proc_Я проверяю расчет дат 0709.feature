...
|'Код WBS'|
|'<КодТекущейРаботы>'|
И в таблице "РаботыДЗ" поле с именем "РаботыНачалоПериода" имеет значение <Начало>
И в таблице "РаботыДЗ" поле с именем "РаботыКонецПериода" имеет значение <Конец>
