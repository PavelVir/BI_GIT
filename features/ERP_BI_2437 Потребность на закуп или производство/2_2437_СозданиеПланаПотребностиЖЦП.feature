...
Сценарий: Я создаю план потребности в материалах на ЖЦП
	...
	Тогда таблица "РесурсыМатериалыДЗ" стала равной:
		...
		| ''               | 'Работа на квартал'  | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | ''                   | 'Бензин А-92'  | 'Сентябрь' | '29,670330'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '29,670330'         |
		| ''               | ''                   | 'Болт'         | 'Сентябрь' | '59,340659'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '59,340659'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Октябрь'  | '30,659341'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '30,659341'         |
		| ''               | ''                   | 'Болт'         | 'Октябрь'  | '61,318681'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '61,318681'         |
		| ''               | ''                   | 'Бензин А-92'  | 'Ноябрь'   | '29,670329'  | 'шт'                | '1,00000'               | 'л/дм3'            | 'Материал1' | '29,670329'         |
		| ''               | ''                   | 'Болт'         | 'Ноябрь'   | '59,340658'  | 'шт'                | '1,00000'               | 'шт'               | 'Материал2' | '59,340658'         |
		| ''               | 'Конструктив 2'      | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
		| ''               | 'Работа на два года' | ''             | ''         | ''           | ''                  | ''                      | ''                 | ''          | ''                  |
