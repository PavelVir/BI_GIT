...
Сценарий: Я Проверяю работу обработки загрузки формата556 с ошибкой - без накладных и сметной прибыли 
	...
	И в таблице "РаботыДЗ" поле "Стоимость прямых затрат" имеет значение "400 001 257,41"
	И в таблице "РаботыДЗ" поле "НР 1 уровня" имеет значение "11 238 825,78"
	И в таблице "РаботыДЗ" поле "НР 2 уровня" имеет значение ""
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "24 674 478,97"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "435 914 562,16"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-435 914 562,16"
