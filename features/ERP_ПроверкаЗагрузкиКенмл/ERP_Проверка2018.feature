...
Сценарий: Я Проверяю работу обработки загрузки формата2018
	...
	И в таблице "РаботыДЗ" поле "НР 2 уровня" имеет значение "6 816 180,36"
	И в таблице "РаботыДЗ" поле "Сметная прибыль" имеет значение "4 072 902,17"
	И в таблице "РаботыДЗ" поле "Себестоимость всего" имеет значение "54 984 173,60"
	...
	И в таблице "РаботыДЗ" поле "Маржа" имеет значение "-54 984 173,60"
